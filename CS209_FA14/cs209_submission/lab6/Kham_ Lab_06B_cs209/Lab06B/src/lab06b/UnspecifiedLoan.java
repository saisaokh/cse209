...
public class UnspecifiedLoan  
    ...
    //**************************************************************************************************************************
    public UnspecifiedLoan (String nam, int id, double propCost, double downPay, int numYears ) {
...
//****************************************************************************************************************************
 ...
 //**************************************************************************************************************************** 
    ...
    public String toString() {
        ...
        str =  "Loan Type: Lab06_V3: UnspecifiedLoan ,"+ "Name: " + borrowerName + ", ID: " + loanId + ", Cost: " + prec2.format(propertyCost)
